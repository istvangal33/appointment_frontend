...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="hidden lg:flex fixed left-0 top-0 h-full w-24 bg-white shadow-lg border-r border-[#004a6d] z-50 flex-col">
        <div className="flex flex-col items-center justify-between h-full py-6">
          ...
          <nav className="flex flex-col space-y-6 items-center">
            <Link
              ...
              pathname === "/bemutatkozas"
                ? "text-[#ec7007]" // aktív oldal → narancs
                : "text-[#004a6d] hover:text-[#ec7007]" // alap: kék, hover: narancs
            }`}
              title="Bemutatkozás"
            >
              <svg
            ...
            <Link
              href="/elerhetoseg"
              className={`group flex flex-col items-center transition-colors ${
              pathname === "/elerhetoseg"
                ? "text-[#ec7007]" 
                : "text-[#004a6d] hover:text-[#ec7007]" 
            }`}
              title="Elérhetőség"
            >
              <svg
            ...
            >
              ...
              <span className="text-xs text-center">Galéria</span>
            </Link>
          ...
          <div className="flex flex-col items-center space-y-2">
            <Link
              href="/elerhetoseg"
              className="btn flex flex-col items-center px-3 py-3 rounded-full border border-[#004a6d] text-[#004a6d] font-medium transition-all hover:bg-[#ec7007] hover:text-white"
              title="Contact me"
            >
              <svg
            ...
            <div className="mt-4 mb-4 rounded-lg bg-white shadow-lg border border-gray-100">
              <nav className="flex flex-col px-4 py-4 space-y-2 text-gray-800 font-medium">
                <Link
                  ...
                  onClick={() => setIsMenuOpen(false)}  // <<< menü bezárás
                >
                  Bemutatkozás
                </Link>
                <Link
