...
const services = [
  ...
  { 
    ...
    desc: "A kinesio tape egy rugalmas tapasz, amely támogatja az izmokat és ízületeket anélkül, hogy korlátozná a mozgást. Segíthet fájdalomcsökkentésben, regenerációban és mozgásszervi problémák kezelésében, szakszerű felhelyezéssel.",
  ...
  { 
    ...
    desc: "A sportsérülések hobbi- és élsportolókat egyaránt érinthetnek. Személyre szabott rehabilitációs programjaink célja a gyors felépülés, az erő, mozgékonyság és állóképesség helyreállítása, valamint a sérülések megelőzése. ",
